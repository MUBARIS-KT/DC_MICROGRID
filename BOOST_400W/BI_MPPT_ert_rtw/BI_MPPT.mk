###########################################################################
## Makefile generated for component 'BI_MPPT'. 
## 
## Makefile     : BI_MPPT.mk
## Generated on : Wed Jan 10 14:48:23 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BI_MPPT.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BI_MPPT.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/BI_MPPT_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230/F2802X~1/include -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230/F2802X~4/include -IC:/ti/CONTRO~1//libs/math/IQmath/v160/include -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230
...
DEFINES_STANDARD = -DMODEL=BI_MPPT -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_csl.c $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_board.c $(START_DIR)/BI_MPPT_ert_rtw/BI_MPPT.c $(START_DIR)/BI_MPPT_ert_rtw/BI_MPPT_data.c $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_adc.c $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_pwm.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2802xBoard_Realtime_Support.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/MW_c28xGlobalInterrupts.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_cputimers.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_defaultisr.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_headers/source/F2802x_GlobalVariableDefs.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_piectrl.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_pievect.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_sysctrl.c C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_usdelay.asm C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_codestartbranch.asm C:/ti/controlSUITE/device_support/f2802x/v230/f2802x_common/source/f2802x_adc.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2000HardwareTimerConfig.c $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/MW_c28xGPIO.c $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2802xSchedulerTimer0.c

MAIN_SRC = $(START_DIR)/BI_MPPT_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/BI_MPPT_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/BI_MPPT_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/BI_MPPT_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/BI_MPPT_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


BI_MPPT.obj : $(START_DIR)/BI_MPPT_ert_rtw/BI_MPPT.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


BI_MPPT_data.obj : $(START_DIR)/BI_MPPT_ert_rtw/BI_MPPT_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/BI_MPPT_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/BI_MPPT_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
